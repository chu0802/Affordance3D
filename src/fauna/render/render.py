...
from src.fauna.render import light
from src.fauna.render import renderutils as ru
from src.fauna.render import util
from src.fauna.render.texture import Texture2D
...
def shade(
    ...
    if isinstance(material, Texture2D):
        ...
        if im_features_map is None:
            ...
            all_tex = material.sample(
                gb_tex_pos,
                feat=feat,
                feat_map=im_features_map,
                mvp=mvp,
                w2c=w2c,
                deform_xyz=gb_pos,
            )
    ...
    if (
        material is None
        or isinstance(material, Texture2D)
        or not material.perturb_normal
    ):
        perturbed_nrm = None
