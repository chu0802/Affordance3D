...
from src.fauna.render import mlptexture, texture, util
from src.fauna.render.render import render_uv
...
@torch.no_grad()
def save_mtl(
    fn, material, mesh=None, feat=None, resolution=[256, 256], prior_shape=None
):
    ...
    with open(fn, "w") as f:
        ...
        if material is not None:
            ...
            if "kd_ks_normal" in material.keys():
                ...
                mask, kd, ks, normal = render_uv(
                    glctx,
                    mesh,
                    resolution,
                    material["kd_ks_normal"],
                    feat=feat,
